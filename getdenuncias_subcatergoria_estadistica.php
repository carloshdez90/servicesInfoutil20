...
*/	
    ...
    $registros=mysql_query("SELECT IDSUBCATEGORIA, count(IDSUBCATEGORIA) as totalDenunciasSub FROM COMENTARIO WHERE IDSUBCATEGORIA = $idsubcat AND TIPO=1", $conexion) or
