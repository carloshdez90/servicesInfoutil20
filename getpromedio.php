...
$tabla = array(
    ...
    $registros=mysql_query("SELECT IDSUBCATEGORIA, AVG( PROMEVALUACION ) as PromCategoria FROM ELEMENTO WHERE IDCATEGORIA = $idcat GROUP BY IDSUBCATEGORIA", $conexion) or
	...
	while ($reg=mysql_fetch_assoc($registros))
	{
     ...
     $registros2=mysql_query("SELECT IDSUBCATEGORIA, AVG( PROMEVALUACION ) as PromCategoria FROM ELEMENTO WHERE IDCATEGORIA = $idcat", $conexion) or
    die(json_encode($respuesta));
    ...
    $answ = array('PromCategoria' => $filas, 'Total'=>$filas2);
