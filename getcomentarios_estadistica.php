...
$tabla = array(
    ...
    $registros=mysql_query("SELECT IDSUBCATEGORIA, count(IDSUBCATEGORIA) as totalSub FROM COMENTARIO WHERE IDCATEGORIA = $idcat AND TIPO=0 GROUP BY IDSUBCATEGORIA", $conexion) or
